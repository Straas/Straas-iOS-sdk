...
/// <ul>
///   <li>
///     The streaming statistics. Return nil if <code>state</code> is not <code>STSStreamingStateStreaming</code>.
///   </li>
/// </ul>
@property (nonatomic, readonly, strong) STSStreamingStatsReport * _Nullable streamingStatsReport;
@property (nonatomic) enum AVCaptureDevicePosition captureDevicePosition;
@property (nonatomic, readonly) STSStreamingState state;
@property (nonatomic, readonly, copy) NSString * _Nonnull JWT;
...
@interface StreamingManager (SWIFT_EXTENSION(StraaSStreamingSDK))
- (void)prepareWithPreviewView:(MTHKView * _Nonnull)previewView configuration:(STSStreamingPrepareConfig * _Nonnull)configuration success:(void (^ _Nonnull)(CGSize))success failure:(void (^ _Nonnull)(NSError * _Nonnull))failure;
/// <ul>
///   <li>
...
///     \endcode</li>
/// </ul>
- (void)prepareWithVideoSize:(CGSize)videoSize previewView:(MTHKView * _Nonnull)previewView outputImageOrientation:(UIInterfaceOrientation)outputImageOrientation success:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(NSError * _Nonnull))failure;
